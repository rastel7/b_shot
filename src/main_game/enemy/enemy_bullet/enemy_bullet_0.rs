...
pub fn spawn_enemy_bullet0(
    ...
    let entity = commands
        .spawn((
            ...
            Transform::from_translation(position.to_vec3()),
            AseSpriteSlice {
...
pub fn update_enemy_bullet0(
    mut commands: Commands,
    mut bullet_query: Query<(Entity, &mut EnemyBullet0, &mut EnemyBullet, &mut Transform)>,
    time: Res<Time>,
) {
    for (entity, mut bullet0, mut bullet, mut transform) in bullet_query.iter_mut() {
